...
INSERT INTO `address` VALUES (1,1,'Arthur','9491234567','500 Campus Dr','CA','92612'),(2,1,'Arthur','9491234567','499 Campus Dr','CA','92612'),(3,2,'Ben','9491234567','500 Campus Dr','CA','92612'),(4,2,'Bob','9491234567','500 Campus Dr','CA','92612'),(5,3,'Cindy','9491234567','500 Campus Dr','CA','92612'),(6,4,'Doug','9491234567','500 Campus Dr','CA','92612'),(7,5,'Ella','9491234567','500 Campus Dr','CA','92612'),(8,6,'Father','9491234567','500 Campus Dr','CA','92612'),(9,7,'Grace','9491234567','500 Campus Dr','CA','92612'),(10,8,'Helen','9491234567','500 Campus Dr','CA','92612'),(11,9,'Vera','9491234567','500 Campus Dr','CA','92612');
...
CREATE TABLE `figure` (
  ...
  PRIMARY KEY (`fid`),
  KEY `figure_pid` (`pid`),
  CONSTRAINT `figure_fk` FOREIGN KEY (`pid`) REFERENCES `product` (`pid`)
...
CREATE TABLE `orders` (
  ...
  KEY `order_aid_fk_idx` (`aid`),
  KEY `order_uid` (`uid`,`create_time` DESC),
  CONSTRAINT `order_aid_fk` FOREIGN KEY (`aid`) REFERENCES `address` (`aid`),
...
INSERT INTO `orders` VALUES (1,'20210412XYZ01',1,11,1,2000,'2021-04-12 00:00:00','placed'),(2,'20210412XYZ02',1,12,2,3000,'2021-04-12 00:00:00','paid'),(3,'20210412XYZ03',9,13,11,4000,'2021-04-12 00:00:00','shipped'),(4,'20210412XYZ04',3,4,3,202,'2021-04-15 00:00:00','paid');
...
INSERT INTO `user` VALUES (1,'Arthur','ABC123','user','\0'),(2,'Ben','ABC123','user','\0'),(3,'Cindy','ABC123','user','\0'),(4,'Doug','ABC123','user','\0'),(5,'Elen','ABC123','user','\0'),(6,'Frank','ABC123','user','\0'),(7,'Grace','ABC123','user','\0'),(8,'Helen','ABC123','user','\0'),(9,'Irwin','ABC123','admin','\0'),(10,'Sophie','ABC123','user','\0'),(11,'Vera','ABC123','user','\0');
...
CREATE TABLE `user_info` (
  ...
  `uid` int NOT NULL,
  `portrait` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '给个默认头像',
  `phone` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `email` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `gender` enum('female','male','other','unknown') CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `birthday` date DEFAULT NULL,
  `regis_date` date NOT NULL,
  `balance` double NOT NULL DEFAULT '0',
  PRIMARY KEY (`uiid`) USING BTREE,
  KEY `uid` (`uid`) USING BTREE,
  CONSTRAINT `user_info_fk1` FOREIGN KEY (`uid`) REFERENCES `user` (`uid`) ON DELETE RESTRICT ON UPDATE CASCADE
...
INSERT INTO `wishlist` VALUES (1,1,4,'2021-04-15 00:00:00'),(2,1,5,'2021-04-15 00:00:00'),(3,1,6,'2021-04-15 00:00:00'),(4,1,10,'2021-04-15 00:00:00'),(5,2,1,'2021-04-15 00:00:00'),(6,2,2,'2021-04-15 00:00:00'),(7,2,3,'2021-04-15 00:00:00'),(8,2,10,'2021-04-15 00:00:00'),(9,3,4,'2021-04-15 00:00:00'),(10,3,5,'2021-04-15 00:00:00'),(11,3,6,'2021-04-15 00:00:00'),(12,9,9,'2021-04-15 00:00:00');
...
-- Dump completed on 2021-04-19  2:31:24
